...
country_map = containers.Map({'CHN', 'GUI','RUS','GUY','CAN','MAD','RSA','MOZ', 'BRA','GBR','USA','GER','JPN', ...
                                ...
                                'BUL','SIN','PHI','POL','ICE','SUI','INA','ISR','FIN','FRA','THA'}, ...
                             ...
                             [1 2 4 0 0],[5 3 7 2 2],[1 1 3 1 0],[0 1 3 1 0],[0 1 3 0 0],[4 3 5 2 1],[1 1 4 1 0],[0 1 3 0 0],[0 1 3 1 0],[4 2 6 2 1]});
